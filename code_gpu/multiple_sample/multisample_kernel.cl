...
__kernel void Multi_ave(read_only image1d_t particle_x, read_only image1d_t particle_y, read_only image1d_t particle_z, read_only image2d_t imageA, read_only image2d_t imageB, read_only image2d_t imageC,  write_only image2d_t imageOUT, int num)
{
