 ...
 * small angle, using powder method
...
__kernel void Smallangle(read_only image1d_t particle_x, read_only image1d_t particle_y, read_only image1d_t particle_z, read_only image1d_t imageA, read_only image1d_t imageB, read_only image1d_t imageC, write_only image1d_t imageOUT, float coefficient, int num, float f_q)
{
