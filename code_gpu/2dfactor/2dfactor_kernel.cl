...
__kernel void TwoDfactor(read_only image1d_t particle_x, read_only image1d_t particle_y, read_only image1d_t particle_z, read_only image2d_t imageA, read_only image2d_t imageB, read_only image2d_t imageC,  write_only image2d_t imageOUT, int num)
{
	...
	resultOUT = (sum_cos * sum_cos + sum_sin * sum_sin);
